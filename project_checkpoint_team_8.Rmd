...
control <- trainControl(method = "cv", number = 5, 
                        ...
                        verboseIter = TRUE, #print out detailed step information
...
tuneGrid <- expand.grid(
  mtry = c(2, 3, 4, 5)       # You can adjust and add more values based on your dataset
)
...
svm_tune_grid <- expand.grid(
  sigma = c(0.001,0.01),  # Adjust these values based on your understanding of the data scale
  C = c(10, 100, 1000)
)
...
svm_model <- train(
  genre ~ ., 
  data = train_data_updated,
  method = "svmRadial",  # This specifies using a radial basis function kernel
  trControl = control,
...
svm_poly_model <- train(
  genre ~ ., 
  data = train_data_updated,
  method = "svmPoly",  # This specifies using a polynomial kernel
  trControl = control,
